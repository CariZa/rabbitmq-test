...
class publish_engine:
    ...
    def on_delivery_confirmation(self, method_frame):
        ...
        print("\n"
            "=========================")
        print(method_frame)
        print("An %s has been received!!!" %confirmation_type)
        print("Published %i messages and received delivery confirmation for %i messages " %(self._published_messages, self._delivered_messages) )
        print("=========================")

    def publish_message(self):
        print("Now in publish message")
